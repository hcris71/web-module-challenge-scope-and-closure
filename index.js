...
/*Task 1: counterMaker()
  ...
  the difference between counter1 and counter2 is that counter1 has the count inside the function, whereas the second has the count function as a global object.

  2. Which of the two uses a closure? How can you tell?
  counter2 uses a closer because it had access to an external variable, whereas counter1 did not.

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     counter1 would be better for situations where you only need one returned response. Counter2 would be better suited for scenarios where you need data from the function witheld and accumulated and tracked as the code continues. 
*/
